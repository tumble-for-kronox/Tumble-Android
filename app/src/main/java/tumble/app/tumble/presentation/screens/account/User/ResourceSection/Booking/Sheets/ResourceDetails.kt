...
fun ResourceDetailsSheet(
    ...
    onConfirmResource: (String, String) -> Unit,
    ...
    Column(
        ...
        DetailCard(
            ...
            content = {
                Text(
                    text = if (booking.locationId.isNotEmpty()) booking.locationId else stringResource(R.string.no_location),
        ...
        if (booking.showConfirmButton) {
            ActionButtonsSection (
                ...
                onClick = {
                    onConfirmResource(booking.resourceId, booking.id)
                },
