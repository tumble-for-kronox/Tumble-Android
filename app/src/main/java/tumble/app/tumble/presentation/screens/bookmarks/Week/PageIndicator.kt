        ...
        modifier = Modifier
            ...
            .border(
                ...
                color = MaterialTheme.colorScheme.background.copy(
                    red = MaterialTheme.colorScheme.background.red * 0.95f,
                    green = MaterialTheme.colorScheme.background.green * 0.95f,
                    blue = MaterialTheme.colorScheme.background.blue * 0.95f
                ),
                RoundedCornerShape(30.dp)
            ),
