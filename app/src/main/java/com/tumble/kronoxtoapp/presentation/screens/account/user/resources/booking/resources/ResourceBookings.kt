    ...
    Column(
        ...
        when (viewModel.resourceSelectionState) {
            ...
            is ResourceSelectionState.Error -> {
                val errorMessage =
                    (viewModel.resourceSelectionState as ResourceSelectionState.Error).message
                Column(
            ...
            is ResourceSelectionState.Loaded -> {
                val allResources =
                    (viewModel.resourceSelectionState as ResourceSelectionState.Loaded).allResources
